...
if ( ! function_exists( 'giga_store_advanced_sections' ) ) {
	Kirki::add_field( 'giga_store_settings', array(
		...
		'label'       => __( 'Giga Store Advanced Sections are Deactivated', 'giga-store' ),
		...
		'default'     =>  '<a class="install-now button-primary button" href="' . esc_url( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ) . '" aria-label="Install Giga Store Advanced Fields now" data-name="Giga Store Advanced Fields">' . __( 'Install Now','giga-store' ) . '</a>',
		'priority'    => 10,
	) );
}
/**
